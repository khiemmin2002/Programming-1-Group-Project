...
public class LPage {
    ...
    public static void ValidateUserInfo (String username, String password)
    {
        ...
        try {
            ...
            String line1;
            while (((line1 = us.readLine()) != null)) {
                String[] user_values = line1.split(",");
                if ((username.equals(user_values[1]) && password.equals(user_values[2]))) {
                    System.out.println("You got access!");
                } else if (username.equals(user_values[1])){
            ...
            ad.readLine();
            String line2;
            while (((line2 = ad.readLine()) != null)) {
                String[] ad_values = line2.split(",");
                if ((username.equals(ad_values[1]) && password.equals(ad_values[2]))) {
                    System.out.println("You got access!");
                } else if (username.equals(ad_values[1])) {
                    System.out.println("Wrong password, please try again!");
                } else {
                    System.out.println("Username doesn't exist!");
                }
